...
export default function Home() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-10 bg-primaryColor">
            <section>
            ...
            <section>
                ...
                <div className={'image-wrapper'}>
                    <Image src='/images/home/11.png' width={600} height={750} alt="logo"/>
                    <div className={'mt-2'}>
            ...
            <section className={'mt-24'}>
                ...
                <div className={'image-wrapper'}>
                    ...
                    <video width="320" height="600" controls autoPlay preload="none" loop muted className={'video'}>
